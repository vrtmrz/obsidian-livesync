...
export declare class ServiceFileAccessBase<TAdapter extends IFileSystemAdapter<any, any, any, any>>// eslint-disable-line @typescript-eslint/no-explicit-any
 extends ServiceModuleBase<StorageAccessBaseDependencies<TAdapter>> implements StorageAccess {
    private vaultAccess;
