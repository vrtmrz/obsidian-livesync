...
export declare class FileProcessingService<T extends ServiceContext = ServiceContext> extends ServiceBase<T> implements IFileProcessingService {
     ...
     */
    readonly processOptionalFileEvent: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(path: import("../../common/settingConstants").FilePath) => Promise<boolean>>;
    /**
