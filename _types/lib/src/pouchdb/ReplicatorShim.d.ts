...
export type PouchDBShim<T extends object> = {
    ...
    bulkDocs: (docs: PouchDB.Core.PostDocument<object>[], options?: PouchDB.Core.BulkDocsOptions) => Promise<(PouchDB.Core.Response | PouchDB.Core.Error)[]>;
...
export declare function upsert<V extends object, T extends SomeDocument<V> = SomeDocument<V>>(db: CompatibleDatabase<object>, id: string, func: (doc: T) => T): Promise<T>;
