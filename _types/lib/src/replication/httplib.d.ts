import type { CouchDBCredentials, JWTCredentials, JWTHeader, JWTParams, JWTPayload, PreparedJWT } from "@lib/common/models/auth.type";
...
export declare function generateCredentialObject(settings: RemoteDBSettings): {
    jwtAlgorithm: import("@lib/common/models/auth.type").JWTAlgorithm;
    jwtKey: string;
    jwtKid: string;
    jwtSub: string;
