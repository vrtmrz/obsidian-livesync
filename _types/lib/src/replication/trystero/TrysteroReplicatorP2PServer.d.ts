...
import { type ReplicatorHostEnv, type FullFilledDeviceInfo, type Request, type Response, type Payload, type Advertisement, type BindableObject } from "./types";
...
export declare class TrysteroReplicatorP2PServer {
    ...
    get db(): PouchDB.Database<import("../../common/types").EntryDoc>;
