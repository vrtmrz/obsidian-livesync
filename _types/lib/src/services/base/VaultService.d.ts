...
export declare abstract class VaultService<T extends ServiceContext = ServiceContext> extends ServiceBase<T> implements IVaultService {
    ...
    get settings(): import("../../common/types").ObsidianLiveSyncSettings;
     ...
     */
    readonly isIgnoredByIgnoreFile: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(file: string | import("../../common/types").UXFileInfoStub) => Promise<boolean>>;
    /**
     * Check if a file is a target file for synchronisation.
     * @param file The file path or file info stub to check.
     * @param keepFileCheckList Whether to keep the file in the check list.
     */
    readonly isTargetFile: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(file: string | import("../../common/types").UXFileInfoStub) => Promise<boolean>>;
    /**
     * Check if a file is a target file for some extra feature
     */
    readonly isTargetFileInExtra: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(file: string | import("../../common/types").UXFileInfoStub) => Promise<boolean>>;
    /**
