...
export declare abstract class ReplicationService<T extends ServiceContext = ServiceContext> extends ServiceBase<T> implements IReplicationService {
     ...
     */
    readonly processSynchroniseResult: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(doc: import("../../common/types").MetaEntry) => Promise<boolean>>;
    /**
     * Process a synchronisation result document for optional entries i.e., hidden files.
     */
    readonly processOptionalSynchroniseResult: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(doc: import("../../common/types").LoadedEntry) => Promise<boolean>>;
    /**
     * Process an array of synchronisation result documents.
     * @param docs An array of documents to parse and handle.
     */
    readonly parseSynchroniseResult: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(docs: Array<PouchDB.Core.ExistingDocument<import("../../common/types").EntryDoc>>) => Promise<boolean>>;
    /**
     * Process a virtual document (e.g., for customisation sync).
     */
    readonly processVirtualDocument: import("@lib/services/lib/HandlerUtils").BooleanMultipleHandlerFunction<(docs: PouchDB.Core.ExistingDocument<import("../../common/types").EntryDoc>) => Promise<boolean>>;
    /**
