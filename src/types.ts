 ...
 */
export type NecessaryObsidianFeature<
    T extends keyof ObsidianServiceHub,
    U extends keyof ServiceModules = never,
    C extends keyof ObsidianServiceContext = never,
> = {
...
export type NecessaryObsidianServices<
    T extends keyof ObsidianServiceHub,
    U extends keyof ServiceModules = never,
    C extends keyof ObsidianServiceContext = never,
> = NecessaryObsidianFeature<T, U, C>;

export type ObsidianServiceFeatureFunction<
    T extends keyof ObsidianServiceHub,
    U extends keyof ServiceModules,
    C extends keyof ObsidianServiceContext,
    TR,
> = (host: NecessaryObsidianFeature<T, U, C>) => TR;

export function createObsidianServiceFeature<
    T extends keyof ObsidianServiceHub,
    U extends keyof ServiceModules = never,
    C extends keyof ObsidianServiceContext = never,
    TR = void,
>(featureFunction: ObsidianServiceFeatureFunction<T, U, C, TR>): ObsidianServiceFeatureFunction<T, U, C, TR> {
